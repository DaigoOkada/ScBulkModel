...
out_path <- "/home/dokada/work_dir/sc_eqtl_theo_fin0628_cor/"
...
v_score2 <- ((e_mu1d - e_mu2d)^2) * v_r + (e_rd^2) * v_mu1 + ((1 - e_rd)^2) * v_mu2 + v_r * (v_mu1 + v_mu2)
var_scores <- v_score2/v_score
cols <- ifelse(var_scores > 1, "red", "blue")
